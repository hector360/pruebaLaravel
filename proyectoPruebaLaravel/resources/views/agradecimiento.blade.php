...
<body>
    <a href="/">Regresar</a>
    <h2 class="titulo">Agradecimiento</h2>
    
    <div class="card cuadro" style="width: 18rem;">
    <div class="card-body ">
        <h5 class="card-title">Muchas gracias por tu reservación</h5>
        <h6 class="card-subtitle mb-2 text-muted">{{$nombre}} {{$apellido}}</h6>
        <p class="card-text">Su Codigo de reservación es: {{$numReservacion}}</p>
    </div>
    </div>
